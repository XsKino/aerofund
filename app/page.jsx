  ...
  return (
    <main className='w-full'>
      ...
      <section className='bg-white'>
        <div className='py-8 px-4 flex flex-wrap mx-auto max-w-screen-xl text-left lg:py-16 lg:px-6'>
          <div className='max-w-screen-sm'>
            ...
            <p className='mb-8 font-light text-gray-500 lg:mb-16 sm:text-xl'>
              ...
              utility classNamees from Tailwind
            </p>
          </div>
          <div className='grid mb-8 lg:mb-12 lg:grid-cols-2'>
            ...
            <figure className='flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b border-gray-200 md:p-12'>
              <blockquote className='mx-auto mb-8 max-w-2xl'>
                ...
                <p className='my-4'>
                  "FlowBite provides a robust set of design tokens and components based on the
                  popular Tailwind CSS framework. From the most used UI components like forms and
                  navigation bars to the whole app screens designed both for desktop and mobile,
                  this UI kit provides a solid foundation for any project.
                </p>
                <p className='my-4'>
                  Designing with Figma components that can be easily translated to the utility
                  classNamees of Tailwind CSS is a huge timesaver!"
                </p>
              </blockquote>
              <img
                className='w-9 h-9 rounded-full'
            ...
            <figure className='flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b border-gray-200 lg:border-b-0 md:p-12 lg:border-r'>
              <blockquote className='mx-auto mb-8 max-w-2xl text-gray-500'>
                ...
                <p className='my-4'>
                  Aesthetically, the well designed components are beautiful and will undoubtedly
